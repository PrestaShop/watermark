...
class Watermark extends Module
{
    ...
    public function __construct()
    {
        ...
        if (!isset($transparency, $xAlign, $yAlign)) {
        ...
        $this->watermarkManager = new WatermarkManager($yAlign, $xAlign, $transparency);
    }
    ...
    public function install()
    {
        ...
        $this->htaccessManager->writeHtaccessSection();
    ...
    {
        if (!$this->htaccessManager->removeHtaccessSection()) {
    ...
    public function getContent()
    {
        ...
        $this->htaccessManager->removeHtaccessSection();
        $this->htaccessManager->writeHtaccessSection();
